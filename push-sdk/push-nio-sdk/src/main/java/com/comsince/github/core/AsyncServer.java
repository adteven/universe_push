...
import com.comsince.github.core.callback.ListenCallback;
import com.comsince.github.core.future.*;
import com.comsince.github.core.future.Future;
import com.comsince.github.logger.LoggerFactory;
import com.comsince.github.core.utils.StreamUtility;
...
public class AsyncServer {
    ...
    private static Log log = LoggerFactory.getLogger(AsyncServer.class);
    ...
    private void run(boolean newThread) {
        ...
        if (reentrant) {
            try {
                ...
                log.e(LOGTAG, "Selector closed", e);
                try {
