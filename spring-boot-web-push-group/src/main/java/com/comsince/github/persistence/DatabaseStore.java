...
import com.comsince.github.util.Utility;
...
public class DatabaseStore {
    ...
    public Map<Long, MessageBundle> getMessages(Collection<Long> keys) {
    ...
    public MessageBundle getMessage(long messageId) {
    ...
    public void removeChatroomInfo(String chatroomId) {
    ...
    public boolean removeGroupInfoFromDB(String groupId) {
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = DBUtil.getConnection();
